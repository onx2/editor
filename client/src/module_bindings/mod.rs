...
pub mod capsule_y_data_type;
pub mod collision_shape_type;
pub mod heightfield_data_type;
pub mod identity_connected_reducer;
pub mod identity_disconnected_reducer;
pub mod quat_type;
pub mod vec_3_type;
pub mod world_object_type;
pub mod world_objects_table;

pub use capsule_y_data_type::CapsuleYData;
pub use collision_shape_type::CollisionShape;
pub use heightfield_data_type::HeightfieldData;
...
#[doc(hidden)]
pub struct DbUpdate {
    world_objects: __sdk::TableUpdate<WorldObject>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "world_objects" => db_update
                    .world_objects
                    .append(world_objects_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.world_objects = cache
            .apply_diff_to_table::<WorldObject>("world_objects", &self.world_objects)
...
pub struct AppliedDiff<'r> {
    world_objects: __sdk::TableAppliedDiff<'r, WorldObject>,
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        world_objects_table::register_table(client_cache);
    }
}
